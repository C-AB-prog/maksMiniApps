// api/_utils/tg.js  — EDGE-совместимая проверка initData (WebCrypto)
...
async function hmac(signKeyRaw, dataRaw){
  ...
  return crypto.subtle.sign(
    'HMAC',
    key,
    typeof dataRaw === 'string' ? enc.encode(dataRaw) : dataRaw
  );
}

/** Проверка подписи Telegram WebApp initData (Edge) */
